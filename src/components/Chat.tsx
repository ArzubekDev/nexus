...
const {
  ...
  useEffect(() => {
    if (chatId) {
      ...
      console.log(fetchMessages(chatId), "fetchMessage");
    ...
    <section className="z-50 flex-1 h-screen flex flex-col bg-white dark:bg-[#0b0b0e] text-slate-900 dark:text-white overflow-hidden transition-colors duration-300">
              ...
              <div className={isMe ? "text-right" : ""}>
                ...
                <div
                  className={`p-4 rounded-2xl ${
                    isMe
                      ? "bg-purple-600 text-white shadow-md shadow-purple-200 dark:bg-linear-to-r dark:from-[#9d50bb] dark:to-[#6e48aa] dark:shadow-xl dark:shadow-purple-900/20 rounded-tr-none"
                      : "bg-white text-slate-700 border border-slate-100 shadow-sm dark:bg-[#4d38a2] dark:text-white dark:border-none dark:shadow-lg rounded-tl-none"
                  }`}
                >
      ...
      <footer className="p-6 bg-white dark:bg-[#0b0b0e] border-t border-slate-100 dark:border-none">
        <form
          ...
          className="max-w-4xl mx-auto flex items-end gap-4 bg-slate-50 dark:bg-[#1a1a20] p-2 rounded-2xl border border-slate-200 dark:border-white/5 focus-within:border-purple-500/50 transition-all"
        >
          <button
            type="button"
            className="p-3 hover:bg-purple-100 dark:hover:bg-white/5 rounded-xl transition text-slate-400 dark:text-gray-400"
          >
          ...
          <textarea
            ...
            className="flex-1 bg-transparent resize-none border-none outline-none text-sm py-2 px-2 text-slate-700 dark:text-white placeholder-slate-400 dark:placeholder-gray-600"
          />

          {text.trim() ? (
            <button
              type="submit"
              className="p-3 bg-purple-600 hover:bg-purple-700 transition rounded-xl text-white shadow-sm"
            >
            ...
            <button
              type="button"
              className="p-3 bg-white dark:bg-white/5 hover:bg-purple-600 hover:text-white dark:hover:bg-white/10 transition rounded-xl text-purple-600 dark:text-gray-400 shadow-sm border border-slate-200 dark:border-none"
            >
