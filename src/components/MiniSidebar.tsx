      ...
      <div className="mb-8 relative">
        {user ? (
          ...
          >
            ...
            >
              <div className="absolute left-0 top-0 bottom-0 w-3 z-10 pointer-events-none bg-linear-to-r from-[#bebebe] dark:from-[#1a1a20] to-transparent" />
              <div className="absolute right-0 top-0 bottom-0 w-3 z-10 pointer-events-none bg-linear-to-l from-[#bebebe] dark:from-[#1a1a20] to-transparent" />
